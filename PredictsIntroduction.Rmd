...
Land-use type is classified as one of: 

Land-use intensity is classified at one of three levels, with the criteria for classification depending on land-use type (see [@Hudson2017] for more details)
