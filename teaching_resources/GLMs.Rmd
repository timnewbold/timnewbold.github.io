...
These plots show us that this model is behaving as we would expect in terms of homogeneity of variance and normality of residuals (i.e., there are no significant deviations from expectations).

For Poisson GLMs, there is one further assumption that we have not encountered before.

# When Poisson GLMs are Insufficient
